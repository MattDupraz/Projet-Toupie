...
namespace tests {
	...
	// Test unitaires pour les matrices
	void testMatrix3x3() {
	...
	// Test unitaires pour les toupies
	void testTop(){
	...
	// Test unitaires pour les intégrateur
	void testIntegration() {
		...
		struct TestData {
			string file; // fichier de sauvegarde
			Top* top; // toupie à tester
			Integrator& integrator; // intégrateur à tester
		};
		...
		// Écriture aux fichiers a échoué si `error_flag` = true
		if (error_flag) {
